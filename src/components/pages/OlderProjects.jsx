  ...
  return (
    <div>
      ...
      <p className="smaller">Below are my older projects, whether made for school, Game Jams, or just for fun! These are less serious and more personal projects of mine.</p>
        ...
        <p><a href="https://github.com/SnowmanSixtyFour/Portfolio" target="_blank"><img src={GitHub} width="40" height="40" alt="GitHub Repository" title="GitHub Repository"/></a></p>
        <br/>
        <p><a href="/projects">Go back to Projects</a></p>
        <br/>
